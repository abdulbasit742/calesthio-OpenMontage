...
TOOL = {
    'name': 'archive-closeout-delivery-check-helper',
    'script': 'extras/archive_closeout_delivery_check.py',
    'example': 'python extras/archive_closeout_delivery_check.py --delivery-seal archive_closeout_delivery_seal.json --delivery-index archive_closeout_delivery_index.json --label archive-closeout-delivery-check --owner "Archive Owner" --out-json archive_closeout_delivery_check.json --out-md ARCHIVE_CLOSEOUT_DELIVERY_CHECK.md',
    'description': 'Build the final pass or blocked delivery check from the delivery seal and delivery index records.',
    'area': 'portfolio',
    'outputs': [
...
def main():
    parser = argparse.ArgumentParser(description='Archive closeout delivery check command helper for OpenMontage Plus')
